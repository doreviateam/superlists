...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        # She types "Buy peacock feathers" in a text box (Edith's hoby is tying fly-fishing lures)
        ...
        # There is still a text box inviting her to add another item. (must she go back to the home page in order to add a new item?)
        self.browser.get(self.live_server_url)
    ...
    def test_layout_and_styling(self):
        ...
        inputbox.send_keys('text input is centered')
        inputbox.send_keys(Keys.ENTER)

        self.wait_for_row_in_list_table('1: text input is centered')
